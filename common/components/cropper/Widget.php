...
use common\components\cropper\assets\CropperAsset;
...
class Widget extends InputWidget
{
    ...
    public $thumbnailWidth = 600;
    public $thumbnailHeight = 400;
    ...
    public function registerClientAssets()
    {
        ...
        $settings = array_merge([
            ...
            'maxSize' => $this->maxSize / 3000,
            'allowedExtensions' => explode(', ', $this->extensions),
            'size_error_text' => Yii::t('cropper', 'TOO_BIG_ERROR', ['size' => $this->maxSize / (3000 * 3000)]),
    ...
    public static function registerTranslations()
    {
        if (!isset(Yii::$app->i18n->translations['cropper']) && !isset(Yii::$app->i18n->translations['cropper/*'])) {
            Yii::$app->i18n->translations['cropper'] = [
                ...
                'basePath' => '@common/components/cropper/messages',
